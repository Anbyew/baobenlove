...
export const t = {
  en: {
    ...
    ceremonyAddress: '1 Hartefeld Dr, Avondale, PA 19311',
    receptionTime: '6:00 PM – 11:00 PM',
    receptionDinner: 'Dinner at 7:00 PM',
    receptionVenue: 'Longwood Gardens',
    receptionAddress: '419 Conservatory Road, Kennett Square, PA 19348',
    ...
    scheduleEvents: [
      ...
      { time: '6:00 PM', title: 'Cocktail Hour', description: "Signature cocktails and hors d'oeuvres are served in the Main Conservatory Ballroom — we invite you to wander the full conservatory and take in its beauty at your leisure" },
      { time: '7:00 PM', title: 'Reception & Dinner', description: 'A seated dinner featuring seasonal, locally-sourced cuisine in the Fountain Room within the Lower Conservatory' },
    ...
    hotelBlockNote: 'The following hotel blocks were held through Sept 2, 2026 and have since returned to general availability. Rooms may still be available under the Bao–Krakoff wedding at the current rate. For a little extra ease on the wedding day, shuttle service will be provided to and from these hotels.',
    ...
    rsvpWelcomeDinnerAttending: 'Will you be attending the Welcome Dinner? *',
    rsvpWelcomeDinnerHint: 'Friday, October 2, 2026 · 7:00 PM · Eggspectation - Christiana',
    rsvpWelcomeDinnerError: 'Please let us know whether you will be attending the Welcome Dinner.',
    rsvpSectionAttendance: '1. Attendance',
    rsvpSectionGuests: '2. Guest Details',
    rsvpSectionDetails: '3. A Few More Things',
    rsvpMainCoursePlaceholder: 'Select a main course',
    rsvpGuestTab: 'Guest',
    rsvpAddGuest: '+ Add Guest',
    rsvpRemoveGuest: 'Remove',
    rsvpAgeGroup: 'Age Group',
    rsvpAgeUnder21: 'Under 21',
    rsvpAgeOver21: '21 or over',
    rsvpMainCourse: 'Main Course',
    rsvpMainCourseCod: 'Sesame Roasted Black Cod',
    rsvpMainCourseDuck: 'Pan Seared Pennsylvania Duck Breast',
    rsvpMainCourseWellington: 'Heirloom Carrot & Leek Wellington (vegetarian)',
    rsvpMainCourseChildrens: "Children's Meal",
    rsvpMainCourseOther: 'Other',
    rsvpMainCourseOtherPlaceholder: 'Please specify',
    rsvpDietary: 'Dietary Restrictions',
    rsvpDietaryPlaceholder: 'Please let us know of any dietary restrictions',
    rsvpLanguageProficiency: 'Language Proficiency',
    rsvpLanguageEnglish: 'English',
    rsvpLanguageChinese: 'Chinese',
    rsvpLanguageNotAtAll: 'Not at all',
    rsvpLanguageSome: 'More than zero',
    rsvpLanguageGood: 'Good',
    rsvpLanguageNative: 'Native',
    rsvpTransportation: 'Do you need transportation?',
    rsvpTransportationYes: 'Yes',
    rsvpTransportationNo: 'No',
    rsvpTransportationTbd: 'To be determined',
    rsvpSongRequest: 'Song Request',
    rsvpSongPlaceholder: "Any song you'd like to hear?",
    rsvpAnythingElse: 'Anything else? Any questions?',
    rsvpAnythingElsePlaceholder: "Let us know if there's anything else we should know",
    ...
    rsvpGuestFieldError: 'Please fill in each guest’s name, age group, and main course.',
    ...
    faqSections: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            a: 'The ceremony is at [Hartefeld National, 1 Hartefeld Dr, Avondale, PA 19311](https://maps.google.com/?q=1+Hartefeld+Dr,+Avondale,+PA+19311). The cocktail hour and reception follow at [Longwood Gardens, 419 Conservatory Road, Kennett Square, PA 19348](https://maps.google.com/?q=419+Conservatory+Road,+Kennett+Square,+PA+19348), about 30 miles southwest of Philadelphia.',
          },
          {
            q: 'Is there parking available?',
            a: 'Yes. For the wedding day, please use the [West Lot at Longwood Gardens](https://maps.google.com/?q=419+Conservatory+Road,+Kennett+Square,+PA+19348) (419 Conservatory Road) for the reception; ceremony parking is available at [Hartefeld National](https://maps.google.com/?q=1+Hartefeld+Dr,+Avondale,+PA+19311). Longwood is also offering guests complimentary admission on Sunday; if you choose to visit, please use the regular [Visitor Center parking](https://maps.google.com/?q=1001+Longwood+Road,+Kennett+Square,+PA+19348).',
          },
          {
  ...
  zh: {
    ...
    scheduleEvents: [
      ...
      { time: '下午6:00', title: '鸡尾酒时间', description: '精选鸡尾酒与开胃小食将在主温室宴会厅（Main Conservatory Ballroom）供应——我们诚邀您漫步于整座温室之中，尽情欣赏其绝美风光' },
      { time: '晚上7:00', title: '晚宴', description: '在下层温室（Lower Conservatory）喷泉厅（Fountain Room）品尝精心准备的时令本地美食' },
    ...
    hotelBlockNote: '以下酒店的团房预订已于2026年9月2日到期，现已恢复公开预订。您仍可尝试以"包·克拉科夫婚礼"名义预订，费用为当前门市价。为了让婚礼当天更加轻松，我们将为往返这些酒店安排专车接送。',
    exploreTitle: '周边探索',
    ...
    rsvpAccepts: '欣然接受',
    rsvpDeclines: '遗憾婉拒',
    rsvpWelcomeDinnerAttending: '您是否出席欢迎晚宴？*',
    rsvpWelcomeDinnerHint: '10月2日，周五 · 晚上7:00 · Eggspectation - Christiana',
    rsvpWelcomeDinnerError: '请告知我们您是否出席欢迎晚宴。',
    rsvpSectionAttendance: '一、出席情况',
    rsvpSectionGuests: '二、宾客信息',
    rsvpSectionDetails: '三、更多信息',
    rsvpMainCoursePlaceholder: '请选择主菜',
    rsvpGuestTab: '宾客',
    rsvpAddGuest: '+ 添加宾客',
    rsvpRemoveGuest: '移除',
    rsvpAgeGroup: '年龄段',
    rsvpAgeUnder21: '21岁以下',
    rsvpAgeOver21: '21岁及以上',
    rsvpMainCourse: '主菜',
    rsvpMainCourseCod: '芝麻烤黑鳕鱼',
    rsvpMainCourseDuck: '香煎宾夕法尼亚鸭胸',
    rsvpMainCourseWellington: '胡萝卜韭葱惠灵顿（素食）',
    rsvpMainCourseChildrens: '儿童餐',
    rsvpMainCourseOther: '其他',
    rsvpMainCourseOtherPlaceholder: '请说明',
    rsvpDietary: '饮食限制',
    rsvpDietaryPlaceholder: '请告知我们您的饮食限制或过敏情况',
    rsvpLanguageProficiency: '语言能力',
    rsvpLanguageEnglish: '英语',
    rsvpLanguageChinese: '中文',
    rsvpLanguageNotAtAll: '完全不会',
    rsvpLanguageSome: '略懂一些',
    rsvpLanguageGood: '良好',
    rsvpLanguageNative: '母语水平',
    rsvpTransportation: '是否需要交通接送？',
    rsvpTransportationYes: '需要',
    rsvpTransportationNo: '不需要',
    rsvpTransportationTbd: '待定',
    rsvpSongRequest: '点歌',
    rsvpSongPlaceholder: '有什么想听的歌曲吗？',
    rsvpAnythingElse: '还有其他事项或问题吗？',
    rsvpAnythingElsePlaceholder: '如有其他需要告知我们的事项，请在此留言',
    rsvpSaving: '正在保存…',
    rsvpUpdate: '更新回复',
    rsvpSubmit: '提交回复',
    rsvpAttendError: '请告知我们您是否出席。',
    rsvpGuestFieldError: '请填写每位宾客的姓名、年龄段和主菜选择。',
    ...
    faqSections: [
      {
        ...
        items: [
          ...
          {
            q: '婚礼场地在哪里？',
            a: '仪式场地：哈特菲尔德，地址为 1 Hartefeld Dr, Avondale, PA 19311。鸡尾酒时间与晚宴场地：长木花园，地址为 419 Conservatory Road, Kennett Square, PA 19348，位于费城西南约50公里处。',
          },
          {
            q: '场地是否提供停车？',
            a: '是的。婚礼当天，请在长木花园 [West Lot](https://maps.google.com/?q=419+Conservatory+Road,+Kennett+Square,+PA+19348)（419 Conservatory Road）停车参加晚宴；仪式停车位位于 [Hartefeld National](https://maps.google.com/?q=1+Hartefeld+Dr,+Avondale,+PA+19311)。长木花园也将在周日为宾客提供免费入园；若您选择前往参观，请使用常规 [Visitor Center 停车场](https://maps.google.com/?q=1001+Longwood+Road,+Kennett+Square,+PA+19348)。',
          },
          {
            q: '场地与酒店之间是否有交通接送？',
